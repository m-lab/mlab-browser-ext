...
NDT.prototype.getDescription = function () {
  return "The Network Diagnostic Tool (NDT) runs tests between your computer and the nearest M-Lab server, performing diagnostic functions and measuring the overall health of your current connection. For more information, see: http://www.measurementlab.net/tools/ndt";
}
